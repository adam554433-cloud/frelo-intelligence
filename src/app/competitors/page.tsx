      ...
      <div className="mx-auto max-w-5xl px-6 py-10">
        <div className="mb-8">
          ...
          <p className="mt-2 text-text-secondary">
            {trustpilotCount} Trustpilot reviews ingested. Scrape more via /api/ingest/run?source=trustpilot&query=trycreate.co
          </p>
        </div>

        <div className="grid gap-4 sm:grid-cols-2">
          {competitors.map((c) => (
            <div key={c.id} className="rounded-card border border-surface-border bg-surface p-5">
